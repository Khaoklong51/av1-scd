...
min_kf_dist:int = option.min_scence_len
ALL_SOURCE_METHOD:list[str] = option._VALID_METHOD4
...
def _check_vs_source():
    ...
    if vs_decode == ALL_SOURCE_METHOD[0] and not vs_source['bestsource']:
        log.error_log('bestsource is unavailable. Install https://github.com/vapoursynth/bestsource')
    ...
    if vs_decode == ALL_SOURCE_METHOD[2] and not vs_source['lsmash']:
        log.error_log('lsmash is unavailable. Install https://github.com/HomeOfAviSynthPlusEvolution/L-SMASH-Works')
